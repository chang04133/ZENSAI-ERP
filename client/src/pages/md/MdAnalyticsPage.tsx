...
import {
  BarChartOutlined, DollarOutlined, CalendarOutlined,
  BgColorsOutlined, TagsOutlined, HeatMapOutlined, PieChartOutlined, RiseOutlined, ExperimentOutlined, AppstoreOutlined,
...
const StyleProductivityTab = lazy(() => import('./tabs/StyleProductivityTab'));
const VmdEffectTab = lazy(() => import('./tabs/VmdEffectTab'));
...
{ key: 'season', label: <span><CalendarOutlined /> 시즌 성과</span>, children: <Suspense fallback={fallback}><SeasonPerformanceTab /></Suspense> },
    ...
    { key: 'style-prod', label: <span><ExperimentOutlined /> 스타일 생산성</span>, children: <Suspense fallback={fallback}><StyleProductivityTab /></Suspense> },
    { key: 'vmd-effect', label: <span><AppstoreOutlined /> VMD 효과</span>, children: <Suspense fallback={fallback}><VmdEffectTab /></Suspense> },
