...
export default function RestockManagePage() {
  ...
  const columns = [
    ...
    { title: '판매율', dataIndex: 'sell_through_rate', key: 'sell_through_rate', width: 70,
      sorter: (a: RestockSuggestion, b: RestockSuggestion) => Number(a.sell_through_rate) - Number(b.sell_through_rate),
    ...
    { title: `${salesPeriodDays}일판매`, dataIndex: 'total_sold', key: 'total_sold', width: 75,
      sorter: (a: RestockSuggestion, b: RestockSuggestion) => Number(a.total_sold) - Number(b.total_sold),
    ...
    { title: '부족량', dataIndex: 'shortage_qty', key: 'shortage_qty', width: 70,
      sorter: (a: RestockSuggestion, b: RestockSuggestion) => Number(a.shortage_qty) - Number(b.shortage_qty),
    ...
    { title: '소진일', dataIndex: 'days_of_stock', key: 'days_of_stock', width: 65,
      sorter: (a: RestockSuggestion, b: RestockSuggestion) => Number(a.days_of_stock) - Number(b.days_of_stock),
