...
export async function seedDummyData(pool: Pool): Promise<void> {
  ...
  await pool.query(`
    INSERT INTO products (product_code, product_name, category, brand, season, base_price, discount_price, event_price, cost_price, fit, length) VALUES
      ('ZS26SS-T001', '오버핏 코튼 티셔츠', 'TOP', 'ZENSAI', '2026SS', 49000, 39000, 29000, 18000, '오버핏', '레귤러'),
      ('ZS26SS-T002', '슬림핏 스트라이프 셔츠', 'TOP', 'ZENSAI', '2026SS', 69000, 55000, 45000, 25000, '슬림핏', '레귤러'),
      ('ZS26SS-T003', '크롭 니트 탑', 'TOP', 'ZENSAI', '2026SS', 59000, 47000, 35000, 22000, '레귤러핏', '크롭'),
      ('ZS26SS-B001', '와이드 데님 팬츠', 'BOTTOM', 'ZENSAI', '2026SS', 89000, 71000, 59000, 32000, '와이드핏', '롱'),
      ('ZS26SS-B002', '테이퍼드 슬랙스', 'BOTTOM', 'ZENSAI', '2026SS', 79000, 63000, 49000, 28000, '테이퍼드핏', '레귤러'),
      ('ZS26SS-B003', '플리츠 미디스커트', 'BOTTOM', 'ZENSAI', '2026SS', 65000, 52000, 39000, 24000, '레귤러핏', '레귤러'),
      ('ZS26SS-O001', '린넨 블렌드 재킷', 'OUTER', 'ZENSAI', '2026SS', 159000, 127000, 99000, 58000, '레귤러핏', '숏'),
      ('ZS26SS-O002', '라이트 트렌치코트', 'OUTER', 'ZENSAI', '2026SS', 189000, 151000, 119000, 68000, '오버핏', '롱'),
      ('ZS26SS-D001', '플라워 프린트 원피스', 'DRESS', 'ZENSAI', '2026SS', 119000, 95000, 79000, 42000, '레귤러핏', '롱'),
      ('ZS26SS-D002', '리넨 셔츠 원피스', 'DRESS', 'ZENSAI', '2026SS', 99000, 79000, 59000, 36000, '오버사이즈핏', '롱'),
      ('ZS25FW-T001', '캐시미어 블렌드 니트', 'TOP', 'ZENSAI', '2025FW', 89000, 71000, 55000, 32000, '세미오버핏', '레귤러'),
      ('ZS25FW-O001', '울 더블 코트', 'OUTER', 'ZENSAI', '2025FW', 289000, 231000, 189000, 105000, '레귤러핏', '롱'),
      ('ZS25FW-O002', '패딩 점퍼', 'OUTER', 'ZENSAI', '2025FW', 239000, 191000, 149000, 88000, '오버핏', '숏'),
      ('ZS25FW-B001', '기모 스트레이트 팬츠', 'BOTTOM', 'ZENSAI', '2025FW', 79000, 63000, 49000, 28000, '스트레이트핏', '레귤러'),
      ('ZS26SS-A001', '레더 미니 백', 'ACC', 'ZENSAI', '2026SS', 129000, 103000, 79000, 45000, NULL, NULL)
