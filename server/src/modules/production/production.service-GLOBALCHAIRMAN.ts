...
class ProductionService extends BaseService<ProductionPlan> {
  ...
  async categoryDetailedStats(category: string) { return productionRepository.categoryDetailedStats(category); }
  ...
  async getSeasonPlanData(season?: string) {
    return productionRepository.getSeasonPlanData(season);
  }

  async generateSeasonPlanExcel(season: string) {
    return productionRepository.generateSeasonPlanExcel(season);
  }
}
